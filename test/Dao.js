...
describe('Dao', () => {
  ...
  beforeEach(async () => {
    ...
    // send tokens to each investor - each gets 20% of the total supply 
    ...
    //deploy DAO and set quorum to half of total supply plus 1 wei, i.e. 500,001
    const DAO = await ethers.getContractFactory('DAO')
    dao = await DAO.deploy(token.address, '500000000000000000000001')

    // funder sending 100 ether to DAO treasury for governance ( below is how you send ether to anyone or any contract)
